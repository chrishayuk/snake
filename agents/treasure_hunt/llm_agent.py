...
from agents.agent_tag_utils import extract_tag_content, extract_thought_process, extract_time_completed
...
"""
    ...
    def get_action(self, step, state: str):
        ...
        thought_process = extract_thought_process(response, "agentThinking")
        final_output = extract_tag_content(response, "finalOutput")
        time_completed = extract_time_completed('%Y-%m-%d %H:%M:%S')
